...
namespace Socket.Quobject.Collections.Immutable
{
	...
	where TKey : IComparable<TKey>
	{
		...
		{
			bool found;
			return new ImmutableDictionary<TKey, TValue>(this.root.RemoveFromNew(new KeyValuePair<TKey, TValue>(key, default), new Comparison<KeyValuePair<TKey, TValue>>(ImmutableDictionary<TKey, TValue>.CompareKV), out found), this.keyComparer, this.valueComparer);
		}
		...
		{
			IImmutableDictionary<TKey, TValue> immutableDictionary = this;
		...
		{
			return !this.root.SearchNode(new KeyValuePair<TKey, TValue>(key, default), new Comparison<KeyValuePair<TKey, TValue>>(ImmutableDictionary<TKey, TValue>.CompareKV)).IsEmpty;
		}

		public bool TryGetValue(TKey key, out TValue value)
		{
			AvlNode<KeyValuePair<TKey, TValue>> avlNode = this.root.SearchNode(new KeyValuePair<TKey, TValue>(key, default), new Comparison<KeyValuePair<TKey, TValue>>(ImmutableDictionary<TKey, TValue>.CompareKV));
			if (avlNode.IsEmpty)
			{
				value = default;
				return false;
		...
		public sealed class Builder : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable
		{
			...
			{
				bool found;
				this.root = this.root.RemoveFromNew(new KeyValuePair<TKey, TValue>(key, default), new Comparison<KeyValuePair<TKey, TValue>>(ImmutableDictionary<TKey, TValue>.CompareKV), out found);
				return found;
			}
			...
			ICollection<TKey> IDictionary<TKey, TValue>.Keys
			{
				get
				{
					return new List<TKey>(this.Keys);
				}
			}
			...
			ICollection<TValue> IDictionary<TKey, TValue>.Values
			{
				get
				{
					return new List<TValue>(this.Values);
				}
			}
