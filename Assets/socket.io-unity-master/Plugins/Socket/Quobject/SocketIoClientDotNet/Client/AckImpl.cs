	...
	public class AckImpl : IAck
	{
		...
		public void Call(params object[] args)
		{
			if (this.fn != null)
				...
				this.fn1(args.Length != 0 ? args[0] : null);
			else if (this.fn2 != null)
			{
				this.fn2(args.Length != 0 ? args[0] : null, args.Length > 1 ? args[1] : null);
			}
			else
			{
				if (this.fn3 == null)
					return;
				this.fn3(args.Length != 0 ? args[0] : null, args.Length > 1 ? args[1] : null,
