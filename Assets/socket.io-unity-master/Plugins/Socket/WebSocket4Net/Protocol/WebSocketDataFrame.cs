...
namespace Socket.WebSocket4Net.Protocol
{
	public class WebSocketDataFrame
	{
		...
		public bool FIN
		{
			get { return (this.m_InnerData[0] & 128) == 128; }
		}

		public bool RSV1
		{
			get { return (this.m_InnerData[0] & 64) == 64; }
		}

		public bool RSV2
		{
			get { return (this.m_InnerData[0] & 32) == 32; }
		}

		public bool RSV3
		{
			get { return (this.m_InnerData[0] & 16) == 16; }
		}

		public sbyte OpCode
		{
			get { return (sbyte)(this.m_InnerData[0] & 15); }
		}

		public bool HasMask
		{
			get { return (this.m_InnerData[1] & 128) == 128; }
		}

		public sbyte PayloadLenght
		{
			get { return (sbyte)(this.m_InnerData[1] & sbyte.MaxValue); }
		}
		...
		public long ActualPayloadLength
		{
			get
			{
				...
				if (payloadLenght < 126)
					this.m_ActualPayloadLength = payloadLenght;
				else if (payloadLenght == 126)
				{
					this.m_ActualPayloadLength = this.m_InnerData[2] * 256 + this.m_InnerData[3];
				}
				else
				{
					long num1 = 0;
					...
					{
						num1 += this.m_InnerData[index + 2] * num2;
						num2 *= 256;
					}
