...
namespace Socket.Newtonsoft.Json.Utilities
{
	internal abstract class ReflectionDelegateFactory
	{
		public Func<T, object> CreateGet<T>(MemberInfo memberInfo)
		{
			...
			throw new Exception("Could not create getter for {0}.".FormatWith(CultureInfo.InvariantCulture,
			   memberInfo));
		}
		...
		public Action<T, object> CreateSet<T>(MemberInfo memberInfo)
		{
			...
			throw new Exception("Could not create setter for {0}.".FormatWith(CultureInfo.InvariantCulture,
			   memberInfo));
		}
