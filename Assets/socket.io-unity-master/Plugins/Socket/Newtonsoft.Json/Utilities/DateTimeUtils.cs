	...
	internal static class DateTimeUtils
	{
	  ...
	  366
		...
		private static DateTime CreateDateTime(DateTimeParser dateTimeParser)
		{
			...
			dateTime = dateTime.AddTicks(dateTimeParser.Fraction);
			if (flag)
		...
		{
			DateTime result;
			if (DateTime.TryParseExact(text, dateFormatString, culture, DateTimeStyles.RoundtripKind,
			  out result))
			{
		  ...
		  out TimeSpan offset)
		{
			...
			offset = TimeSpan.FromHours(num1) + TimeSpan.FromMinutes(num2);
			if (flag)
