		...
		internal static int Compare(JTokenType valueType, object objA, object objB)
		{
			...
			switch (valueType)
			{
				...
				case JTokenType.Boolean:
					return Convert.ToBoolean(objA, CultureInfo.InvariantCulture).CompareTo(Convert.ToBoolean(objB, CultureInfo.InvariantCulture));
				case JTokenType.Date:
					return ((DateTime)objA).CompareTo(Convert.ToDateTime(objB, CultureInfo.InvariantCulture));
